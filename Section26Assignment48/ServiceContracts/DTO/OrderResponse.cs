...
namespace ServiceContracts.DTO
{
    ...
    public static class OrderExtensions
    {
        ...
        public static OrderResponse ToOrderResponse(this Entities.Order order)
        {
        ...
        public static List<OrderResponse> ToOrderResponseList(this List<Entities.Order> orders)
        {
